...
public class AdapterRecyItem extends RecyclerView.Adapter<ViewHolderItemList> {
    ...
    public void onBindViewHolder(final ViewHolderItemList holder, final int position) {
        ...
        View.OnClickListener twitMap = new View.OnClickListener(){
          @Override
          public void onClick(View view) {
              Intent intentToMap = new Intent(view.getContext(), MtwitMapActivity.class);
              mContext.startActivity(intentToMap);
          }
        };

        holder.buTwitMap.setOnClickListener(twitMap);
